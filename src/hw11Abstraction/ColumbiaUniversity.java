...
public class ColumbiaUniversity extends MedicalSchool implements University, VocationalSchool {
	 ...
	 */
	public void biology() {
		System.out.println("This is a non abstract biology class method from columbiaUniversity class");
	}

	public static void columVersity() {
		System.out.println("This is a static method from Columbia Universit class");
	}

	/*
	 * Default method are only allowed in Interface 
	 * public default void columDefault() {
	 * System.out.println("This is a default method from Columbia University class"); 
	 * }
	 */
